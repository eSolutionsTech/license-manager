...
public interface RSAKeyPairGeneratorInterface {
     ...
     */
    void saveKeyPairToFiles(final KeyPair keyPair,final String privateOutputFileName,final String publicOutputFileName,
                                   final char[] password)
     ...
     * @throws InappropriateKeySpecificationException If the public or private keys are invalid
     */
    void saveKeyPairToProviders(final KeyPair keyPair,final GeneratedClassDescriptor privateKeyProvider,
     ...
     */
    void savePasswordToProvider(final char[] password,final GeneratedClassDescriptor passwordProvider);

    class GeneratedClassDescriptor {
