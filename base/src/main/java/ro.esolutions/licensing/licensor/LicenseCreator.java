 ...
 * in the package of classes (ro.esolutions.licensing.licensor) that is packaged separately from the
...
public final class LicenseCreator {
     ...
     * @throws IllegalArgumentException if {@link LicenseCreatorProperties#setPrivateKeyDataProvider(PrivateKeyDataProvider)
