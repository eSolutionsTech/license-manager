...
public final class LicenseManager {
     ...
     * /> <br /> Throws the same exceptions as {@link #getLicense(Object)} and for the same reasons.
     *
     ...
     * value.<br /> <br /> Throws the same exceptions as {@link #getLicense(Object)} and for the same reasons.
     *
     * @param context    The context (account, client, etc.) for which to check the feature(s) against its license
     ...
     *
     * @param context The context (account, client, etc.) for which to check the feature(s) against its license
     * @param target  The target (a package reflection object, class reflection object or method reflection object) to
     *                check for the {@link FeatureRestriction} annotation and check its value against the license
     * @return {@code false} if the license does not exist, {@code true} if the target is not annotated with {@link
     * FeatureRestriction} and, if it is annotated, {@code true} if the feature(s) is(are) licensed or {@code false} if
     * the feature(s) is(are) not licensed
     * @throws InvalidLicenseException                                   when the license is invalid for any reason.
     * @throws ro.esolutions.licensing.exception.ExpiredLicenseException when the license is expired.
     */
     ...
     * @throws InappropriateKeyException              if there is a problem initializing the verification mechanism with
     *                                                the public key.
     * @throws CorruptSignatureException              if the signature data has been corrupted (most likely tampered
     *                                                with).
