...
public interface LicenseValidator {
     ...
     * @throws InvalidLicenseException                                   when the license is invalid for any reason; the
     *                                                                   implementer is required to provide adequate
     *                                                                   description in this exception to indicate why
     *                                                                   the license is invalid; extending the exception
     *                                                                   is encouraged.
